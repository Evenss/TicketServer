...
CREATE TABLE `user` (
  ...
  `in_time` int(10) NOT NULL COMMENT '录入时间',
  `token` VARCHAR (50) NOT NULL COMMENT '身份验证信息',
  PRIMARY KEY  (`id`)
...
INSERT INTO `user` VALUES ('1', '15957159500', 'e10adc3949ba59abbe56e057f20f883e','786007448@qq.com','1510889131','F56AF215F789499F91AED430E02AC7F7');
INSERT INTO `user` VALUES ('2', '15957159501', 'e10adc3949ba59abbe56e057f20f883e','786007448@qq.com','1510889131','F56AF215F789499F91AED430E02AC7F7');